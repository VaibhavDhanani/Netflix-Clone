      ...
      <div class="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 max-w-md">
        ...
        <form action="#">
          <div class="mb-4">
            ...
            <label for="email" class="mt-2 block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Email</label>
          ...
          <div class="mb-4">
            ...
            <label for="confirmPassword" class="mt-2 block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Confirm Password</label>
          ...
          <div className="flex justify-between ">
            <button onClick={handleSignup} type="submit" class="w-full flex justify-center mx-1 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">Sign Up</button>
